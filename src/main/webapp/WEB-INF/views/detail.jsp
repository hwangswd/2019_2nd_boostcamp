...
<body>
	<div id="container">
		...
		<div class="ct main" data-display-id = "${id}">
			<div>
				...
				<div class="section_event">
					<div class="event_info_box">
						...
						<div class="event_info">
							<div class="in_dsc"><!-- productEvent --></div>
						</div>
					</div>
				</div>
				...
				<div class="section_review_list">
					...
					<a href="/review?id=${id}" class="btn_review_more"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
				</div>
				<div class="section_info_tab">
					<!-- [D] tab 선택 시 anchor에 active 추가 -->
					<ul class="info_tab_lst">
						<li class="item active _detail" data-tab-name="detail">
							<a class="anchor active"> <span>상세정보</span> </a>
						</li>
						<li class="item _path" data-tab-name="path">
	...
	<script type="rsvn_template" id="comment">
		<li class="list_item">
			<div>
