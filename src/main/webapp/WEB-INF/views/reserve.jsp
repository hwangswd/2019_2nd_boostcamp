...
<body>
	<div id="container">
		...
		<div class="ct" data-display-id="${id}">
			<div class="ct_wrap">
				<div class="top_title">
...
<!--					<div class="qty">
				...
				<div class="section_booking_form">
					<div class="booking_form_wrap">
						<div class="form_wrap">
							...
							<form class="form_horizontal" action="api/reservations" method="post" enctype='application/json'>
								<div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
									<div class="inline_control name_wrap">
										...
										<div class="warning_msg">이름에는 문자만 허용됩니다</div>
									</div>
								</div>
	...
	<script type="rsvn_template" id="titleImage">
		<div class="container_visual" style="width: 414px;">
			<ul class="visual_img">
				<li class="item" style="width: 414px;">
					<img alt="" class="img_thumb" src="img/{{fileName}}">
	...
	<script type="rsvn_template" id="detail">
		<div class="store_details">
			<h3 class="in_tit"></h3>
			<p class="dsc">
				장소 : {{placeName}} / {{placeStreet}} (구.{{placeLot}})<br>
				기간 : 
			</p>
			<h3 class="in_tit">관람시간</h3>
			<p class="dsc">
			...
			<h3 class="in_tit">요금</h3>
			<p class="dsc">
				성인(만 19~64세) 원 / 청소년(만 13~18세) 원<br>
				어린이(만 4~12세) 원 / 20인 이상 단체 20% 할인<br>
				국가유공자, 장애인, 65세 이상 원
			</p>
		</div>
	</script>
	<script type="rsvn_template" id="productPrice">
	<div class="qty" data-price-id="{{priceId}}" data-price-type="{{priceTypeName}}">
		<div class="count_control">
			<!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
	...
	<script type="rsvn_template" id="hiddenForm">
